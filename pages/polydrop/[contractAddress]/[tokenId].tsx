...
import {
  ...
  ThirdwebNftMedia,
  useContract,
  useContractEvents, useValidDirectListings,
...
import Skeleton from "../../../evm-engine/components/Skeleton/Skeleton";
import {
  PolyDrop, POLY_MARKETPLACE_ADDRESS
} from "../../../evm-engine/const/contractAddresses";
import randomColor from "../../../evm-engine/util/randomColor";
import toastStyle from "../../../evm-engine/util/toastConfig";
...
export default function TokenPage({ nft, contractMetadata }: Props) {
  ...
  // load list of offers made on direct listing 
...
export const getStaticProps: GetStaticProps = async (context) => {
  ...
  const contract = await sdk.getContract(PolyDrop);
