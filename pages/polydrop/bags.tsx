import {
  ...
  import SaleInfo from "../../components/SaleInfo/SaleInfoPolyDrop";
...
const Bags: NextPage = () => {
    ...
    return (
      ...
      <Container maxWidth="lg">
        <h1 className="text-3xl font-bold">POLY DROP: BAGS</h1>
        <Link href="/polydrop/paperhands" className={styles.link}>
                ...
                <Link href="/polydrop/eththree" className={styles.link}>
                  Collection
                </Link>
                <Link href="/polydrop/eththree" className={styles.link}>
                  ||
