import {
  ...
  export default function SaleInfo({ nft }: Props) {
    ...
    const { contract: nftCollection } = useContract(ETH_3);
      ...
      <>
        ...
        <div className={styles.saleInfoContainer} style={{ marginTop: -42 }}>
          ...
          >
            ...
            <Web3Button
              ...
              onSuccess={(txResult) => {
                ...
                router.push(
                  `/eththree/${ETH_3}/${nft.metadata.id}`
                );
              }}
            >
          ...
          <div
            ...
            style={{ flexDirection: "column" }}
          >
            <h5 className={styles.formSectionTitle}>Be sure to check your <Link href="/" className={styles.link} >
                grift box
