import {
  ...
  import {
    TestKong, POLY_MARKETPLACE_ADDRESS, TUSDC_FOR_MUMBAI
  ...
  export default function SaleInfo({ nft }: Props) {
    ...
    const { contract: nftCollection } = useContract(TestKong);
          ...
          >
            ...
            <Web3Button
              ...
              onSuccess={(txResult) => {
                ...
                router.push(
                  `/TestKong/${TestKong}/${nft.metadata.id}`
                );
              }}
            >
